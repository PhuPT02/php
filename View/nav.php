<nav id=fixedTopNav class="navbar navbar-fixed-top main-navigation" itemscope itemtype=https://schema.org/SiteNavigationElement>
    <div class=container-fluid>
     ...
     <div class="collapse navbar-collapse" id=main-nav-collapse style="margin-right:20px">
            <ul class="nav navbar-nav navbar-right">
                <?php
                    ...
                    <?php }else{?>
                    <li>
                        <a href="<?php echo is_numeric(strpos($value->DuongDan,'#'))?$value->DuongDan:$value->Alias.'-'.$value->Ma?>" itemprop=url>
                            <span itemprop=name>
                                <?php echo $value->Ten?>
                            </span>
                        </a>
