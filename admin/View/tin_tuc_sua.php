                    ...
                    <div class="p-20">
                        <form method='post' class="form-horizontal" role="form">
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <input type="text" class="form-control" name='Ten' value="<?php echo @$this->data->Ten?>" id="Ten"    onchange="stralias('Ten','Alias')"  >
                                </div>
                                <div class='col-3'>
                                ...
                                <div class="col-7">
                                    <select class=" custom-select mt-3" name='MaDanhMuc'>
                                        ...
                                        <?php  
                                            ...
                                            $maa= $this->data->MaDanhMuc;
                                            dequy($this->model->get_ds_danhmuc(),$maa);
                                        ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <textarea class="form-control" rows="5" name="NoiDung" id="NoiDung"><?php echo @$this->data->NoiDung?></textarea>
                                ...
                                <div class="form-group row">
			                    	...
			                    	<div class="col-7">
				                	<input type="hidden" class="form-control" name="Hinh"  value="<?php echo $this->data->Hinh?>" id="Hinh"> 
					                <img src="<?php echo $this->data->Hinh?>" style="with:150px;height:150px" id="img_Hinh" /><button type="button" onclick="openfinder('Hinh')">Chọn hình</button>
				                </div>  
                                </div>                
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <input type="text" class="form-control" name='Alias' value="<?php echo @$this->data->Alias?>" id="Alias" >
                                </div>
                            </div>
